# NWBoxed clone of GitHub Safe-Settings

This is a private clone of [safe-settings](https://github.com/github/safe-settings)
...
1. The precedence order is repository > suborg > org (.github/repos/_.yml > .github/suborgs/_.yml > .github/settings.yml
