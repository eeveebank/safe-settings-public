...
module.exports = class Labels extends Diffable {
  ...
  update (existing, attrs) {
    ...
    return meteredPlugin(this, () => this.github.rest.issues.updateLabel(this.wrapAttrs(attrs)))
  }
  ...
  add (attrs) {
    ...
    return meteredPlugin(this, () => this.github.rest.issues.createLabel(this.wrapAttrs(attrs)).catch(e => this.logError(` ${JSON.stringify(e)}`)))
  }
  ...
  remove (existing) {
    ...
    return meteredPlugin(this, () => this.github.rest.issues.deleteLabel(this.wrapAttrs({ name: existing.name })))
  }
